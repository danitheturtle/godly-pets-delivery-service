...
const PlatformCreateChildGizmoRes = preload("res://addons/stairs_level_editor/gizmos/platform_create_child_gizmo.gd")
...
enum PLACEMENT_MODE {PLATFORMS = 0, PUZZLE_PIECES = 1}
static func get_default_state():
    return {
        placementMode = PLACEMENT_MODE.PLATFORMS,
