...
In this configuration, a stair can fit the slot in 4 different orientations. Two options:
* Use 2 slots for deterministic fixed orientation
* Place slot so its only reachable in a single way
